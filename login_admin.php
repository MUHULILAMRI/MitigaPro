<?php
// login_admin.php — Login Admin MitigaPro
session_start();
...
<head>
    ...
    <title>Login Admin — MitigaPro</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .left-panel::before{content:'';position:absolute;width:500px;height:500px;background:radial-gradient(circle,rgba(59,130,246,0.15),transparent 70%);top:-100px;right:-100px;border-radius:50%}
        .left-panel::after{content:'';position:absolute;width:350px;height:350px;background:radial-gradient(circle,rgba(99,102,241,0.1),transparent 70%);bottom:-80px;left:-60px;border-radius:50%}
        ...
        .left-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(59,130,246,0.15);border:1px solid rgba(59,130,246,0.3);color:#93bbfc;padding:8px 20px;border-radius:20px;font-size:12px;font-weight:600}
        ...
        .role-tag{display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#3b82f6,#6366f1);color:#fff;padding:5px 14px;border-radius:16px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-bottom:24px}
        ...
        .btn-login{width:100%;background:linear-gradient(135deg,#3b82f6,#6366f1);color:#fff;border:none;padding:13px;border-radius:12px;font-size:14px;font-weight:600;font-family:'Poppins',sans-serif;cursor:pointer;transition:opacity .2s,transform .2s;margin-top:6px;box-shadow:0 4px 16px rgba(59,130,246,0.25)}
        ...
        .loading-wheel{width:44px;height:44px;border:4px solid #e2e8f0;border-top-color:#3b82f6;border-radius:50%;animation:spin 1s linear infinite}
...
<div class="left-panel">
    <div class="left-content">
        ...
        <div class="left-badge"><i class="fas fa-shield-halved"></i> Panel Administrator</div>
    </div>
</div>

<div class="right-panel">
    <div class="form-card">
        <span class="role-tag"><i class="fas fa-shield-halved"></i> Admin</span>
